...
export const TOPICS: Topic[] = [
  {
    ...
    verses: [
      { reference: "Philippians 4:6-7", book: "Philippians", chapter: 4, verseStart: 6, verseEnd: 7, preview: "Do not be anxious about anything, but in everything by prayer..." },
  ...
  },
  {
    ...
    verses: [
      { reference: "Deuteronomy 31:6", book: "Deuteronomy", chapter: 31, verseStart: 6, preview: "He will not fail thee, nor forsake thee." },
      ...
      { reference: "Romans 8:38-39", book: "Romans", chapter: 8, verseStart: 38, verseEnd: 39, preview: "Nothing shall be able to separate us from the love of God..." },
  ...
  },
  {
    ...
    verses: [
      { reference: "Psalms 139:14", book: "Psalms", chapter: 139, verseStart: 14, preview: "I am fearfully and wonderfully made..." },
      { reference: "Ephesians 2:10", book: "Ephesians", chapter: 2, verseStart: 10, preview: "For we are his workmanship, created in Christ Jesus..." },
  ...
  },
  {
    ...
    verses: [
      ...
      { reference: "Ephesians 2:10", book: "Ephesians", chapter: 2, verseStart: 10, preview: "Created in Christ Jesus unto good works..." },
  ...
  },
  {
    ...
    verses: [
      ...
      { reference: "Psalms 34:18", book: "Psalms", chapter: 34, verseStart: 18, preview: "The LORD is nigh unto them that are of a broken heart..." },
      { reference: "Revelation 21:4", book: "Revelation", chapter: 21, verseStart: 4, preview: "God shall wipe away all tears from their eyes..." },
      { reference: "Isaiah 61:1-3", book: "Isaiah", chapter: 61, verseStart: 1, verseEnd: 3, preview: "To bind up the brokenhearted... beauty for ashes..." },
      ...
      { reference: "2 Corinthians 1:3-4", book: "2 Corinthians", chapter: 1, verseStart: 3, verseEnd: 4, preview: "The God of all comfort; who comforteth us in all our tribulation..." },
    ],
  },
  {
    id: "fear",
    ...
    verses: [
      { reference: "2 Timothy 1:7", book: "2 Timothy", chapter: 1, verseStart: 7, preview: "God hath not given us the spirit of fear; but of power..." },
      ...
      { reference: "Joshua 1:9", book: "Joshua", chapter: 1, verseStart: 9, preview: "Be strong and of a good courage; be not afraid..." },
  ...
  },
  {
    ...
    verses: [
      { reference: "Ephesians 4:32", book: "Ephesians", chapter: 4, verseStart: 32, preview: "Be ye kind one to another, tenderhearted, forgiving one another..." },
      { reference: "Colossians 3:13", book: "Colossians", chapter: 3, verseStart: 13, preview: "Forbearing one another, and forgiving one another..." },
      ...
      { reference: "1 John 1:9", book: "1 John", chapter: 1, verseStart: 9, preview: "If we confess our sins, he is faithful and just to forgive us..." },
  ...
  },
  {
    ...
    verses: [
      ...
      { reference: "2 Corinthians 12:9", book: "2 Corinthians", chapter: 12, verseStart: 9, preview: "My grace is sufficient for thee: for my strength is made perfect..." },
      ...
      { reference: "James 1:2-4", book: "James", chapter: 1, verseStart: 2, verseEnd: 4, preview: "Count it all joy when ye fall into divers temptations..." },
